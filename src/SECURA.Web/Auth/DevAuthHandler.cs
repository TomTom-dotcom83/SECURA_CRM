...
/// Auto-authenticates every request as a CarrierAdmin so all policies pass
/// without needing a real Entra ID tenant.
/// </summary>
    ...
    : AuthenticationHandler<AuthenticationSchemeOptions>(options, logger, encoder)
{
    ...
    // Suppress the redirect-to-login challenge so API callers get 401 instead.
